...
{{% notice note %}}
Checkout the latest stable release. Current stable release: [Kalpeni(v1.5.0)](https://github.com/sodafoundation/soda/releases/tag/v1.5.0). If you want to get the master branch of all components, you can skip this step. (Master may not be stable or tested fully)
{{% /notice %}}
