...
- **Prerequisite**
   ...
   - Get superuser priviledges:
	...
	- **Get and Install Release Binaries**
	 ...
	 For example, you can get RELEASE_TAG v1.2.0 with https://github.com/sodafoundation/installer/releases/download/v1.2.0
	 
 	**OR** Download the installer binaries from  
 	[https://github.com/sodafoundation/installer/releases/tag/{{ RELEASE_TAG }}]
 	For example, to download RELEASE_TAG v1.2.0 binaries [Hawaii (v1.2.0) release installer binaries](https://github.com/sodafoundation/installer/releases/tag/v1.2.0)
