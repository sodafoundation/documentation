...
accent-color: auto|_color_|initial|inherit;
...
backdrop-filter: none|_filter_|initial|inherit;
...
border-block: _border-block-width_ _border-block-style_ _border-block-color_ |initial|inherit;
